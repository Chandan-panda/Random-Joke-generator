let jokes=[`1day santa had a dream,in that some1 killed him.Next day he closed his bank a/c. B’coz bank’s slogan was ‘WE MAKE YOUR DREAMS COME TRUE’` ,
...
const br=document.getElementById("joke");
btn.addEventListener(`click`, () => {
  let index = Math.ceil(Math.random() * 86);
  br.innerHTML = jokes[index];
  console.log(`clicked`);
});
